        ...
        setInterval(function(){
            $.ajax({
                ...
                success : function(data) {
                    ...
                    $(".progression_os").html(json.progression_os);
                    if(json.scan_stat == "finished"){
                        $(".appsgrabb_success").show();
                        $(".start").show();
                        $(".start_finish_time").html(json.start_finish_time);
                        //start
                        //alert("YES");
                    }else if(json.scan_stat == "ongoing"){
        ...
        <div class="da-panel-content">
            <form id="da-ex-validate1" class="da-form">
                <div class="da-form-inline">
                    ...
                    <div class="da-message success appsgrabb_success" hidden="true">FINISHED, &nbsp; in &nbsp; : &nbsp;&nbsp;<span class="start_finish_time"></span></div>
    ...
    <div class="da-panel-widget">
        ...
        <ul class="da-summary-stat">
            ...
            <li><a href="#"> <span class="da-summary-icon"
                            ...
                            class="value progression_os">0</span> <span class="label">Scanned
                            OSs</span>
                    </span>
                </a>
            </li>
