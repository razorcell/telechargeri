...
<!-- CSS Reset -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl;?>/css/reset.css" media="screen" />
<!--  Fluid Grid System -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl;?>/css/fluid.css" media="screen" />
<!-- Login Stylesheet -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl;?>/css/login.css" media="screen" />

<!-- Required JavaScript Files -->
<script type="text/javascript" src="<?php echo $this->baseurl;?>/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<?php echo $this->baseurl;?>/js/jquery.placeholder.js"></script>
<script type="text/javascript" src="<?php echo $this->baseurl;?>/plugins/validate/jquery.validate.min.js"></script>

<!-- Core JavaScript Files -->
<script type="text/javascript" src="<?php echo $this->baseurl;?>/js/core/dandelion.login.js"></script>
	...
	<div id="da-login-box-wrapper">
    	...
    	<div id="da-login-box">
            ...
            <div id="da-login-box-content">
            	<form id="da-login-form" method="post" action="dashboard.html">
