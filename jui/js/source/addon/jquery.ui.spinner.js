	...
	_createButtons: function(input) {
		...
		var self = this,
			...
			wrapper = self.wrapper = input
				.wrap('<span class="ui-spinner ui-widget"></span>').parent(),
			btnContainer = self.btnContainer = $(
				'<span class="ui-spinner-buttons">' + 
					'<span class="ui-spinner-up ui-spinner-button ui-state-default ui-corner-tr"><span class="ui-icon '+options.upIconClass+'">&nbsp;</span></span>' + 
					'<span class="ui-spinner-down ui-spinner-button ui-state-default ui-corner-br"><span class="ui-icon '+options.downIconClass+'">&nbsp;</span></span>' + 
				'</span>'),
